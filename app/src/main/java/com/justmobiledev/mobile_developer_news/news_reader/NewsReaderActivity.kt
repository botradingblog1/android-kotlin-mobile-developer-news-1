                ...
                arguments = Bundle().apply {
                    putString(
                        MainMenuDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(MainMenuDetailFragment.ARG_ITEM_ID))
                    putString(
                        MainMenuDetailFragment.ARG_ITEM_NAME,
                        intent.getStringExtra(MainMenuDetailFragment.ARG_ITEM_NAME))
                }
            }
